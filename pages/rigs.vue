      ...
      <section id="story">
        <div class="container section-container">
          <div class="px-6 sm:px-12 py-12 md:py-48">
            <h1 data-aos="fade-up" class="section-header font-Orbitron w-full h-auto text-5xl lg:text-6xl choose leading-tighter mb-4 lg:mb-10">
              Tableland awaits...
            </h1>
            ...
            <p class="text-xl lg:text-2xl leading-normal md:leading-normal font-light mb-10 lg:mb-18" data-aos="fade-up">
              <img src="~assets/img/rigs/pioneer_1.jpg" class="text-flow right" style="width:30%;" />
            ...
            <p class="text-xl lg:text-2xl leading-normal md:leading-normal font-light mb-10 lg:mb-18" data-aos="fade-up">
              <img src="~assets/img/rigs/grid.jpg" class="text-flow left" style="width:50%;" />
            ...
            <p class="text-xl lg:text-2xl leading-normal md:leading-normal font-light mb-10 lg:mb-18" data-aos="fade-up">
              <img src="~assets/img/rigs/pioneer_2.jpg" class="text-flow right" style="width:30%;" />
        ...
        <section id="fleets">
          <div class="container section-container">
            <div class="px-6 sm:px-12 pt-0 xl:pt-10 md:pb-24">
              <h1 class="w-full h-auto font-Orbitron text-5xl lg:text-6xl xl:text-7xl leading-tighter mb-4 lg:mb-10" data-aos="fade-up">
                Fleets
              </h1>
              <p class="text-xl lg:text-2xl leading-normal md:leading-normal font-light mb-10 lg:mb-18" data-aos="fade-up">
              ...
              <p class="text-xl lg:text-2xl leading-normal md:leading-normal font-light mb-10 lg:mb-18" data-aos="fade-up">
                <img src="~assets/img/rigs/assembly.jpg" class="text-flow right" style="width:50%;" />
        ...
        <section id="upgrades">
          <div class="container section-container">
            <div class="px-6 sm:px-12 pt-36 pb-12">
              <h1 data-aos="fade-up" class="section-header font-Orbitron w-full h-auto text-5xl lg:text-6xl xl:text-7xl choose leading-tighter mb-10 lg:mb-18">
                Community upgrades
              </h1>
              <p class="text-xl lg:text-2xl leading-normal md:leading-normal font-light mb-10 lg:mb-18" data-aos="fade-up">
                <img src="~assets/img/rigs/community.jpg" class="text-flow" style="width:100%;" />
              ...
              <p class="text-xl lg:text-2xl leading-normal md:leading-normal font-light mb-10 lg:mb-18" data-aos="fade-up">
                Badges are distinct and can only be earned by working in Tableland. Engineers, validators, stewards, and educators display Badges on their Rig for all to see.
              </p>
              <div class="container flex flex-col items-center text-sm mb-10 lg:mb-18">
                <div class="w-full grid gap-10 grid-cols-2 sm:grid-cols-3">
                  <figure class="m-auto">
                    <img src="~assets/img/rigs/badges/code.png" />
                    <figcaption class="text-center pt-2">Earned by coding</figcaption>
                  </figure>
                  <figure class="m-auto">
                    <img src="~assets/img/rigs/badges/teaching.png" />
                    <figcaption class="text-center pt-2">Earned by teaching</figcaption>
                  </figure>
                  <figure class="m-auto">
                    <img src="~assets/img/rigs/badges/education.png" />
                    <figcaption class="text-center pt-2">Earned with education</figcaption>
                  </figure>
                  <figure class="m-auto">
                    <img src="~assets/img/rigs/badges/rewards.png" />
                    <figcaption class="text-center pt-2">Earned by network validators</figcaption>
                  </figure>
                  <figure class="m-auto">
                    <img src="~assets/img/rigs/badges/success.png" />
                    <figcaption class="text-center pt-2">Earned by killer apps</figcaption>
                  </figure>
                  <figure class="m-auto">
                    <img src="~assets/img/rigs/badges/filecoin.png" />
                    <figcaption class="text-center pt-2">Earned by leveraging Filecoin</figcaption>
                  </figure>
                </div>
              </div>
              <p class="text-xl lg:text-2xl leading-normal md:leading-normal font-light mb-10 lg:mb-18" data-aos="fade-up">
                Builders sometimes contribute so much that they’ll only show their most prized Badges. Since badged Rigs stay badged, this custom is also a way for builders to leave a mark on their Rig forever—an experience powered by Tableland's protocols.
              </p>
...
> UPDATE rig_badges SET visible = true WHERE rig_id = 56 AND badge_id = 17;
              ...
              <p class="text-xl lg:text-2xl leading-normal md:leading-normal font-light mb-10 lg:mb-18" data-aos="fade-up">
                <img src="~assets/img/rigs/badged.jpg" class="text-flow" style="width:100%;" />
                The Dawn Ski Piggy is an Original from the Tumbler Fleet. The owner is showing badges for their effors in coding and teaching.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="artists" class="bg-black pb-32 lg:pb-48">
          <div class="container section-container">
            <div class="px-6 sm:px-12 py-24 lg:py-48">
              <h1 class="w-full h-auto font-Orbitron text-5xl lg:text-6xl xl:text-7xl leading-tighter mb-10 lg:mb-18" data-aos="fade-up">
                The Artists
              </h1>
              <p class="text-xl lg:text-2xl leading-normal md:leading-normal font-light mb-10 lg:mb-18" data-aos="fade-up">
                <img src="~assets/img/rigs/oddfellows.jpg" class="text-flow" style="width:100%;" />
