<template>
  <div class="mint-page">
    ...
    <section class="rigs-hero">
      ...
      <div class="container px-0 sm:px-12 md:px-36 lg:px-48 xl:px-12 flex pt-8 lg:pt-12 2xl:pt-32 justify-between">
        <div class="lg:w-full px-6 lg:pb-12 pb-6 pt-12" data-aos="fade-up">
          <div class="lg:flex">
            <div class="lg:w-2/3 w-full pt-6">
              <h1 class="w-full h-auto font-Orbitron text-white text-4xl md:text-5xl lg:text-6xl xl:text-7xl leading-tighter mb-12 lg:mb-10">
                Meet the <span class="font-black">Rigs</span>
              </h1>
            </div>
            <div class="hidden lg:inline-block lg:w-1/3 w-full px-0 lg:px-0 lg:pt-10 pt-0 text-right">
      ...
      <div class="container sm:px-12 md:px-36 lg:px-48 xl:px-12 px-0 pt-0 lg:pt-0" data-aos="fade-up">
        <div class="w-full md:w-full lg:w-1/2 xl:w-1/2 px-6 lg:pb-0 pb-0 pt-0">
          <h1 class="text-white w-full h-auto text-xl md:text-2xl xl:text-2xl leading-tighter mb-4 lg:mb-10">
        ...
        <div class="w-full px-6 lg:pb-0 pb-0 pt-0">
          <ButtonLink href="/samples">See some more</ButtonLink>
        </div>
      </div>
    </section>
    ...
    <div class="story">
      ...
      <section id="story">
        <div class="container section-container">
          <div class="lg:px-12 py-6 md:py-24">
            <h1 data-aos="fade-up" class="section-header font-Orbitron w-full h-auto text-4xl lg:text-6xl choose leading-tighter mb-4 lg:mb-10">
              Tableland awaits...
            </h1>
            ...
            <p class="text-xl lg:text-2xl leading-normal md:leading-normal font-light mb-10 lg:mb-18" data-aos="fade-up">
              <img src="~assets/img/story/pioneer_1.jpg" class="text-flow right" style="width:30%;" />
            ...
            <p class="text-xl lg:text-2xl leading-normal md:leading-normal font-light mb-10 lg:mb-18" data-aos="fade-up">
              <img src="~assets/img/story/grid.jpg" class="text-flow left" style="width:50%;" />
            ...
            <p class="text-xl lg:text-2xl leading-normal md:leading-normal font-light mb-10 lg:mb-18" data-aos="fade-up">
              <img src="~assets/img/story/pioneer_2.jpg" class="text-flow right" style="width:30%;" />
            ...
            <p class="text-xl lg:text-2xl leading-normal md:leading-normal font-light" data-aos="fade-up">
    ...
    <div>
      <div class="bg-solid">
        ...
        <section id="fleets">
          <div class="container section-container">
            <div class="lg:px-12 md:pb-24">
              <h1 class="w-full h-auto font-Orbitron text-4xl md:text-5xl lg:text-6xl xl:text-7xl leading-tighter mb-12 lg:mb-10" data-aos="fade-up">
                Fleets
              </h1>
              <p class="text-xl lg:text-2xl leading-normal md:leading-normal font-light mb-10 lg:mb-18" data-aos="fade-up">
              ...
              <p class="text-xl lg:text-2xl leading-normal md:leading-normal font-light" data-aos="fade-up">
                Combining parts can be quite useful in Tableland. Nevertheless, a small faction of degens are obsessed with re-building every Original Rig. So far, they have managed to assemble one of each Original Rig—181 in total. If you pilot an Original, consider yourself lucky.
              </p>
            </div>
          </div>
        </section>
        <section id="titans">
          ...
          <div class="flex">
            <div class="animated-carousel w-full" data-aos="fade-up">
              <div v-for="(item, index) in titans" :key="index" class="vehicle" style="animation-delay:1s;">
                <img :src="item" />
              </div>
            </div>
          </div>
          <div class="container section-container">
            <div class="lg:px-12 md:pb-24">
              <p class="text-xl lg:text-2xl leading-normal md:leading-normal font-light mb-4 lg:mb-10" data-aos="fade-up">
                Heavy loader, lifters, and haulers of the high desert. The Titans are the muscle of Tableland. If you need to get sh*t done, you’re gonna need a Titan.
              </p>
              <div class="flex">
                <div class="w-1/2">
                  <h3 class="lg:text-2xl text-xl">ORIGINALS</h3>
                  <h2 class="text-4xl font-Orbitron">28</h2>
                </div>
                <div class="w-1/2">
                  <h3 class="lg:text-2xl text-xl">RIG STYLES</h3>
        ...
        <section id="tumblers">
          ...
          <div class="flex">
            <div class="animated-carousel w-full" data-aos="fade-up">
              <div v-for="(item, index) in tumblers" :key="index" class="vehicle" style="animation-delay:3s;">
                <img :src="item" />
              </div>
            </div>
          </div>
          <div class="container section-container">
            <div class="lg:px-12 md:pb-24">
              <p class="text-xl lg:text-2xl leading-normal md:leading-normal font-light mb-4 lg:mb-10" data-aos="fade-up">
                Titans younger brother. Tumblers are a bundle of might packed into a small package. They can fit into tight spaces and what they lack in cargo capacity they make up for in range and agility.
              </p>
              <div class="flex">
                <div class="w-1/2">
                  <h3 class="lg:text-2xl text-xl">ORIGINALS</h3>
        ...
        <section id="Sleds">
          ...
          <div class="flex">
            <div class="animated-carousel w-full" data-aos="fade-up">
              <div v-for="(item, index) in sleds" :key="index" class="vehicle" style="animation-delay:1s;">
                <img :src="item" />
              </div>
            </div>
          </div>
          <div class="container section-container">
            <div class="lg:px-12 md:pb-24">
              <p class="text-xl lg:text-2xl leading-normal md:leading-normal font-light mb-4 lg:mb-10" data-aos="fade-up">
                Running the salt flats takes focus. If you need a stable Rig for the fast and straight, set your sights on a sled. Sure they’re loud, but it drowns out the sound of your teeth vibrating in your skull as you break the sound barrier.
              </p>
              <div class="flex">
                <div class="w-1/2">
                  <h3 class="lg:text-2xl text-xl">ORIGINALS</h3>
        ...
        <section id="edgeriders">
          ...
          <div class="flex">
            <div class="animated-carousel w-full" data-aos="fade-up">
              <div v-for="(item, index) in edge_riders" :key="index" class="vehicle" style="animation-delay:3s;">
                <img :src="item" />
              </div>
            </div>
          </div>
        ...
        <section id="tracers">
          ...
          <div class="flex">
            <div class="animated-carousel w-full" data-aos="fade-up">
              <div v-for="(item, index) in tracers" :key="index" class="vehicle" style="animation-delay:5s;">
                <img :src="item" />
              </div>
            </div>
          </div>
          <div class="container section-container">
            <div class="lg:px-12 md:pb-24">
              <p class="text-xl lg:text-2xl leading-normal md:leading-normal font-light mb-4 lg:mb-10" data-aos="fade-up">
                If you’ve got verticality issues then Tracers are what you seek. Designed to hug the canyonlands and rise and fall faster than Gamestonk.
              </p>
              <div class="flex">
                <div class="w-1/2">
                  <h3 class="lg:text-2xl text-xl">ORIGINALS</h3>
        ...
        <section id="hoppers">
          ...
          <div class="flex">
            <div class="animated-carousel w-full" data-aos="fade-up">
              <div v-for="(item, index) in hoppers" :key="index" class="vehicle" style="animation-delay:1s;">
                <img :src="item" />
              </div>
            </div>
          </div>
          <div class="container section-container">
            <div class="lg:px-12 md:pb-24">
              <p class="text-xl lg:text-2xl leading-normal md:leading-normal font-light mb-4 lg:mb-10" data-aos="fade-up">
                Hoppers are Tracers’ smaller, more nimble cousins. If you’re prone to whiting out, you’re gonna want a G-suit to keep the blood from pooling in your boots.
              </p>
              <div class="flex">
                <div class="w-1/2">
                  <h3 class="lg:text-2xl text-xl">ORIGINALS</h3>
        ...
        <section id="airelights">
          ...
          <div class="flex">
            <div class="animated-carousel w-full" data-aos="fade-up">
              <div v-for="(item, index) in airelights" :key="index" class="vehicle" style="animation-delay:3s;">
                <img :src="item" />
              </div>
            </div>
          </div>
        ...
        <section id="foils">
          ...
          <div class="flex">
            <div class="animated-carousel w-full" data-aos="fade-up">
              <div v-for="(item, index) in foils" :key="index" class="vehicle" style="animation-delay:5s;">
                <img :src="item" />
              </div>
            </div>
          </div>
          <div class="container section-container">
            <div class="lg:px-12 md:pb-24">
              <p class="text-xl lg:text-2xl leading-normal md:leading-normal font-light mb-4 lg:mb-10" data-aos="fade-up">
                Aero, fast, and light. Foils are Moore’s Law personified. If you need to get off-chain in a hurry, you’ll be glad you’ve got a foil.
              </p>
              <div class="flex">
                <div class="w-1/2">
                  <h3 class="lg:text-2xl text-xl">ORIGINALS</h3>
        ...
        <section id="upgrades">
          <div class="container section-container">
            <div class="lg:px-12 py-6 md:py-24">
              ...
              <p class="text-xl lg:text-2xl leading-normal md:leading-normal font-light mb-10 lg:mb-18" data-aos="fade-up">
                <img src="~assets/img/story/meet_the_pioneers2.png" class="text-flow" style="width:100%;" />
                The power of Rigs is in their ability to evolve with immutable on-chain rules—a powerful primitive enabled by the Tableland protocol. Based on how an owner decides to explore Tableland, their Rig will change before their eyes.
              </p>
              <p class="text-xl lg:text-2xl leading-normal md:leading-normal font-light mb-10 lg:mb-18" data-aos="fade-up">
              ...
              <p class="code" data-aos="fade-up">
                <pre>
                  <code>UPDATE rig_badges SET visible = true WHERE rig_id = 56 AND badge_id = 17;</code>
                </pre>
              </p>
            </div>
          </div>
        ...
        <section id="artists">
          <div class="container section-container">
            <div class="lg:px-12 py-6 md:py-24">
              <h1 class="section-header w-full h-auto font-Orbitron text-4xl md:text-5xl lg:text-6xl xl:text-7xl leading-tighter mb-12 lg:mb-10" data-aos="fade-up">
                The Artists
              </h1>
              <p class="text-xl lg:text-2xl leading-normal md:leading-normal font-light mb-10 lg:mb-18" data-aos="fade-up">
                <img src="~assets/img/story/oddfellows.jpg" class="text-flow" style="width:100%;" />
                The Rigs project was developed alongside an über-talented team of artists and writers from <a href="https://oddfellows.tv" target="_blank">Oddfellows</a>.
              </p>
              ...
              <p class="text-xl lg:text-2xl leading-normal md:leading-normal font-light mb-10 lg:mb-18" data-aos="fade-up">
                <ul>
                  <li>Chris Kelly (<a href="https://www.instagram.com/chruskelly/" target="_blank">Instagram</a>)</li>
                  <li>Colin Trenter (<a href="https://twitter.com/wesleytrents" target="_blank">Twitter</a>)</li>
                </ul>
              </p>
              <h2 data-aos="fade-up" class="font-Orbitron h-auto text-2xl lg:text-4xl choose leading-tighter mb-4 lg:mb-10">
                Executive Producer
              ...
              <p class="text-xl lg:text-2xl leading-normal md:leading-normal font-light mb-10 lg:mb-18" data-aos="fade-up">
                <ul>
                  <li>Erica Kelly (<a href="https://www.instagram.com/ericafellow/" target="_blank">Instagram</a>)</li>
                </ul>
              </p>
              <h2 data-aos="fade-up" class="font-Orbitron h-auto text-2xl lg:text-4xl choose leading-tighter mb-4 lg:mb-10">
                Producers
              ...
              <p class="text-xl lg:text-2xl leading-normal md:leading-normal font-light mb-10 lg:mb-18" data-aos="fade-up">
                <ul>
                  <li>Dennis Samatulski (<a href="https://www.dennisdidthat.com/" target="_blank">Homepage</a>)</li>
                  <li>Desiree Etzel (<a href="https://www.instagram.com/desetzel/" target="_blank">Instagram</a>)</li>
                </ul>
              </p>
              <h2 data-aos="fade-up" class="font-Orbitron h-auto text-2xl lg:text-4xl choose leading-tighter mb-4 lg:mb-10">
                Art Direction
              ...
              <p class="text-xl lg:text-2xl leading-normal md:leading-normal font-light mb-10 lg:mb-18" data-aos="fade-up">
                <ul>
                  <li>Joyce Liu (<a href="https://twitter.com/joiceloo_art" target="_blank">Twitter</a>)</li>
                  <li>Amy Sun (<a href="https://www.instagram.com/amysunstory/" target="_blank">Instagram</a>)</li>
                  <li>Yuki Yamada</li>
                  <li>Justin Burks (<a href="https://www.instagram.com/justin_burks_/" target="_blank">Instagram</a>)</li>
                  <li>Caroline Choi (<a href="https://www.instagram.com/j._.n/" target="_blank">Instagram</a>)</li>
                </ul>
              </p>
              <h2 data-aos="fade-up" class="font-Orbitron h-auto text-2xl lg:text-4xl choose leading-tighter mb-4 lg:mb-10">
                Writing Direction
              ...
              <p class="text-xl lg:text-2xl leading-normal md:leading-normal font-light mb-10 lg:mb-18" data-aos="fade-up">
                <ul>
                  <li>inside.company (<a href="https://www.inside.company/" target="_blank">Website</a>)</li>
                </ul>
              </p>
            </div>
          </div>
...
export default {
  ...
  data: function () {
    const now = new Date();
    const launchDate = new Date(2022, 5, 14, 10, 0);
