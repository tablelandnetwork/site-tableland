<template>
  <div>
    ...
    <section class="cohort">
      <div
        class="container px-6 sm:px-6 md:px-24 lg:px-42 flex items-left pt-64 lg:pt-64"
      >
        <div class="lg:w-2/3 md:w-full" data-aos="fade-up" style="margin: auto">
          <h1
            class="font-Orbitron w-full h-auto text-4xl md:text-5xl lg:text-6xl xl:text-7xl leading-tighter mb-4 lg:mb-10"
          >
      ...
      <div class="container lg:py-16 px-4 lg:px-16">
        <div class="flex">
          <div class="lg:w-2/3 px-2">
            <h1
              data-aos="fade-up"
              class="text-pink font-Orbitron w-full h-auto text-2xl lg:text-4xl leading-tighter mb-0 lg:mb-10"
            >
              Tableland is a composable data network that brings SQL to smart
              contracts on Ethereum and other EVM-compatible chains. Read and
              write structured data to the blockchain to supercharge NFTs,
              games, metaverse experiences, and all of web3.
            </h1>
          </div>
          <div
            data-aos="fade-up"
        ...
        <div class="lg:flex lg:py-12">
          <div class="lg:w-1/2 w-full lg:mt-48 mt-24">
            <img src="~assets/img/wall2.png" />
          </div>
          <div class="lg:w-1/2 px-12 py-12 lg:py-32 lg:mt-32">
            <p
              data-aos="fade-up"
              class="text-pink text-xl lg:text-3xl leading-normal md:leading-normal font-light mb-10 lg:mb-18"
            >
              We’re home to those who are in pursuit of that same vision, and
              we’re ready to support them with tools, resources, and rewards.
            </p>
          </div>
        </div>
        ...
        <div class="lg:flex py-12">
          <div class="lg:w-1/2 px-0 py-12">
            <h1
              data-aos="fade-up"
              class="text-pink font-Orbitron w-full h-auto text-3xl lg:text-6xl leading-tighter mb-4 lg:mb-10"
            >
              Tableland is seeking pioneers on a mission to push the boundaries
              of web3.
            </h1>
            <p
              data-aos="fade-up"
            ...
            >
              ...
              mentors, public showcases, and more. Running September 28 to November 
              16th, the program is low-lift and high reward for any builder with 
      ...
      <div class="container px-6 md:px-9 lg:px-16 pt-24">
        <div class="flex py-12 px-12 text-center">
          <div class="w-full px-12 lg:pt-24 py-0">
            <h1
              class="font-Orbitron w-full h-auto text-4xl md:text-5xl lg:text-6xl xl:text-7xl leading-tighter mb-4 lg:mb-10 text-white"
            >
              Why should i apply?
            </h1>
          </div>
        ...
        >
          <div class="lg:px-12 py-0">
            <img
              class="icon py-12"
              src="~assets/img/wrench2.png"
              data-aos="fade-up"
            />
            <p class="font-Orbitron text-3xl" data-aos="fade-up">
              Connect and Learn at the Frontier
            </p>
            <br />
            <p
            ...
            >
              ...
              onboarding onto the Tableland stack. Connect with other leading
              developers at the frontier.
            </p>
          </div>
          <div class="lg:px-12 py-0">
            <img
              class="icon py-12"
              src="~assets/img/chip2.png"
              data-aos="fade-up"
            />
            <p class="font-Orbitron text-3xl" data-aos="fade-up">
          ...
          <div class="lg:px-12 py-0">
            <img
              class="icon py-12"
              src="~assets/img/match2.png"
              data-aos="fade-up"
            />
            <p class="font-Orbitron text-3xl" data-aos="fade-up">Rigs NFT</p>
            <br />
            <p
              class="text-xl leading-normal md:leading-normal font-light mb-10 lg:mb-18"
              data-aos="fade-up"
    ...
    <section class="md:block showcase py-32 relative">
      <div class="container px-24 md:px-32 lg:px-48">
        <div class="text-center">
          ...
          >
            If you’re ready to explore the frontiers together
          </p>
          <ButtonLink href="https://hhueol4i6vp.typeform.com/to/b1VDj6sU"
            >Apply Now</ButtonLink
          >
        </div>
      </div>
    </section>
    ...
    return {
      ...
      meta: [
        ...
        { hid: "og-type", property: "og:type", content: "website" },
        {
          hid: "og-title",
          property: "og:title",
          content: "Tableland Pilot Program",
        },
        {
          hid: "og-sitename",
          property: "og:site_name",
          content: "tableland.xyz/pilot-program",
        },
        {
          hid: "og-desc",
          property: "og:description",
          content: "Learn, connect, and build on the frontiers of the Web.",
        },
        {
          hid: "og-image",
          property: "og:image",
