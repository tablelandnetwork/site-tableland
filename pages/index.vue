<template>
  <div>
    ...
    <section class="hero">
      <div class="container">
        <div
          class="px-6 md:px-9 lg:px-16 flex items-center pt-36 md:pt-48 mb-4 sm:mb-48"
        >
          <div class="lg:w-2/3">
            <h1
              class="font-Orbitron text-5xl md:text-6xl xl:text-7xl leading-tighter mb-4 lg:mb-10"
              data-aos="fade-up"
            >
            ...
            <div
              ...
              data-aos="fade-up"
            >
              <ButtonLink href="https://docs.tableland.xyz"
                >Get started</ButtonLink
              >
            </div>
            <p
              class="hidden text-2xl md:text-3xl lg:text-4.25xl leading-snug md:leading-snug font-medium"
              data-aos="fade-up"
            >
              Use familiar SQL tables to read and write NFT metadata or
              application data governed by immutable rules–all orchestrated by
              token networks like Ethereum.
            </p>
          </div>
        </div>
        <div class="px-6 md:px-9 lg:px-16 flex">
          <div class="w-full lg:w-1/2">
            <h1
              class="font-Orbitron text-4xl md:text-5xl leading-tighter mb-4 lg:mb-10 choose"
              data-aos="fade-up"
            >
        ...
        <div class="px-6 md:px-9 lg:px-16 flex">
          <div class="xl:w-1/2 w-full py-12">
            <p
              class="hidden sm:block text-xl md:text-2xl leading-normal md:leading-normal font-light mb-10 lg:mb-18"
              data-aos="fade-up"
            >
              NFTs can be a building block to unite technological communities.
    ...
    <section class="garage">
      <div class="container px-6 md:px-9 lg:px-16 flex items-center">
        <div class="lg:w-2/3">
          <h3
            class="font-Orbitron text-white text-4xl md:text-5xl lg:text-6xl leading-tighter mb-10 md:mb-4 lg:mb-10"
            data-aos="fade-up"
          >
            Welcome to Tableland
          </h3>
          <p
            class="text-white text-xl md:text-2xl lg:text-3xl leading-normal md:leading-normal lg:leading-normal font-light mb-2"
            data-aos="fade-up"
          >
            1> Use tables to store mutable NFT metadata governed by immutable
            rules.
          </p>
          <p
            class="text-white text-xl md:text-2xl lg:text-3xl leading-normal md:leading-normal lg:leading-normal font-light mb-2"
          ...
          <p
            class="text-white text-xl md:text-2xl lg:text-3xl leading-normal md:leading-normal lg:leading-normal font-light mb-10 lg:mb-18"
            data-aos="fade-up"
          >
            4> Use tables to build fully decentralized apps and games that
    ...
    <section class="sql">
      ...
      <div class="container px-6 md:px-9 lg:px-16 flex pt-10 xl:pt-14">
        <div class="lg:w-2/3 xl:w-1/2">
          ...
          <p
            class="text-xl md:text-3xl leading-normal md:leading-normal font-light mb-2"
          >
          ...
          <p
            class="text-xl md:text-3xl leading-normal md:leading-normal font-light mb-2"
          >
            2> Your familiar SQL tables are stored on a decentralized network of
            validators and anchored to an EVM layer of your choice as
            transferable NFTs, providing ownership and access control.
          </p>
          <p
            class="text-xl md:text-3xl leading-normal md:leading-normal font-light"
          >
            3> Easy as pie, right?
          </p>
        </div>
    ...
    <section class="community relative">
      <div class="container px-6 md:px-9 lg:px-16">
        <div class="community-top pt-32">
          <div class="md:w-2/3 xl:w-1/2">
            ...
            <p
              ...
              data-aos="fade-up"
            >
              Whether you're a developer, NFT creator, token holder, or just
              curious about web3, there's a place for you in Tableland. Join a
        ...
        <div
          class="community-bottom md:flex justify-center lg:justify-end text-white"
        >
          <div>
            <h3
              class="font-Orbitron text-4xl md:text-5xl lg:text-6xl leading-tighter md:leading-tighter lg:leading-tighter mb-4 lg:mb-10"
              data-aos="fade-up"
            >
            ...
            <p
              ...
              data-aos="fade-up"
            >
              Web3 needs a relational and queryable metadata layer. Tableland is
              a decentralized user-owned network for structured metadata—data
              from apps, games, social, analytics, AI/ML, or whatever else you
              can imagine. Tableland tables are also NFTs, making them own-able,
              tradable, and composable assets themselves.
            </p>
          </div>
        </div>
      </div>
