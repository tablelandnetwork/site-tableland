co<template>
  <div>
    ...
    <section class="cohort">
      ...
      <div class="container px-48 flex items-left pt-32 lg:pt-32">
        <div class="lg:w-2/3" data-aos="fade-up" style="margin:auto">
          ...
          <p class="text-2xl leading-normal md:leading-normal font-light mb-10 lg:mb-18">
            Join our summer cohort for access to exclusive mentorship, hackathons, and small group learning on the cutting edge of the open web.</p>
          <a href="#start" class="btn bg-black text-white">Apply Now</a>
            <br id="js-scroll"/>
          </div>
        </div>
      </section>
        ...
        <div class="rig-break"></div>
          <div class="container py-16 px-16 ">
            ...
            <div class="flex py-12">
              ...
              <div class="w-1/2 px-12 py-32 mt-32" >
                <p data-aos="fade-up" class="text-pink text-3xl leading-normal md:leading-normal font-light mb-10 lg:mb-18">
