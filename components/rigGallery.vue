...
<div class="flex flex-wrap py-0 rig-garage">
     <div class="w-1/4 px-3 py-3 rigs" v-for="(rig, index) in rigsMeta.rigs" :key="index" data-aos="fade-up" v-if="currentFilter === rig.attributes[1].value || currentFilter === 'All'">
       <a :href="'/rigs/' + rig.id ">
