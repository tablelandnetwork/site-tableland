    ...
    async init() {
      ...
      if (window.ethereum) {
        ...
        if (window.location.pathname == "/minter/") {
          ...
          console.log("rig price: " + rigPrice);
